            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        ...
                        <li><a href="{{route('vendor.dashbaord')}}">Panel del Vendedpr</a></li>
                        @elseif (auth()->user()->role === 'admin')
                        <li><a href="{{route('admin.dashbaord')}}">Panel Administrador</a></li>
                                    ...
                                    <div class="accordion-body">
                                        <ul>
                                            @foreach ($categoryItem->subCategories as $subCategoryItem)
                                                <li><a href="{{$subCategoryItem->name}}">{{$subCategoryItem->name}}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>

        ...
        <div class="row justify-content-between">
            ...
            <div class="col-xl-4 col-sm-7 col-md-8 col-lg-5">
                <div class="wsus__footer_content wsus__footer_content_2">
                    <h3>Subscribete</h3>
                    <p>Obten la última información de los eventos, ventas y ofertas.
                        Consigue la ultima información de los productos.</p>
                    <form action="" method="POST" id="newsletter">
                        @csrf
                        <input type="text" placeholder="Email" name="email" class="newsletter_email">
                        <button type="submit" class="common_btn subscribe_btn">subscribete</button>
                    </form>

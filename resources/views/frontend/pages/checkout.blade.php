                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;">Pagar</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7">
                    <div class="wsus__check_form">
                        <h5>Detalles de envío <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">agregar
                            nueva direccion</a></h5>
                        <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="wsus__checkout_single_address">
                                        ...
                                        <ul>
                                            ...
                                            <li><span>Código Zip:</span> {{ $address->zip }}</li>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="wsus__order_details" id="sticky_sidebar">
                        ...
                        <div class="wsus__order_details_summery">
                            ...
                            <p>Gastos de envío(+): <span id="shipping_fee">{{ $settings->currency_icon }}0.00</span></p>
                            <p>Cupon(-): <span>{{ $settings->currency_icon }}{{ getCartDiscount() }}</span></p>
                            <p><b>Total:</b>
                        ...
                        <div class="terms_area">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="flexCheckChecked3">
                                    He leído y acepto el sitio web <a href="#">Terminos y condiciones *</a>
                                </label>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <select class="select_2" name="country">
                                                <option value="AL">Pais / Región *</option>

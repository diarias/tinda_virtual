                ...
                <div class="col-xxl-9 col-xl-8 col-lg-8">
                    <div class="wsus__main_blog">
                        ...
                        <p class="wsus__main_blog_header">
                            <span><i class="fas fa-user-tie"></i> por {{$blog->user->name}}</span>
                        ...
                        <div class="wsus__comment_area">
                            <h4>Comentarios <span>{{count($comments)}}</span>{{count($comments)}}</h4>
                        ...
                        <div class="wsus__post_comment">
                            ...
                            <form action="{{route('user.blog-comment')}}" method="POST">
                                ...
                                <button class="common_btn" type="submit">Publica un comentario</button>
                            </form>
                            @else
                            <p>Por favor inicia sesión para comentar!</p>
                            <a class="common_btn" href="{{route('login')}}" >Iniciar Sesión</a>
                            @endif
                        </div>
                    </div>
                </div>
                        ...
                        <div class="wsus__blog_post">
                            ...
                            <div class="wsus__blog_post_single">
                                ...
                                <div class="wsus__blog_post_text">
                                    ...
                                    <p> <span>{{date('M d Y', strtotime($blog->created_at))}} </span> </p>{{-- {{count($blog->comments)}} Comment--}}
                                </div>
                            </div>
                            @endforeach

                ...
                <div class="row">
                        ...
                        <div class="wsus__payment_menu" id="sticky_sidebar">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <button class="nav-link common_btn" id="v-pills-profile-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="v-pills-profile" aria-selected="false">Contra Entrega</button>
                              <!--  <button class="nav-link common_btn" id="v-pills-settings-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-settings" type="button" role="tab"
                                    aria-controls="v-pills-settings" aria-selected="false"> pago bancario</button>-->
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        <div class="tab-content" id="v-pills-tabContent" id="sticky_sidebar">
                            ...
                            <div class="row">
                                <div class="col-xl-12 m-auto">
                                    <div class="wsus__payment_area">
                                       <a class="nav-link common_btn" href="{{route('user.paypal.payment')}}">Pagar con PayPal</a> 
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="wsus__pay_booking_summary" id="sticky_sidebar2">
                            ...
                            <p>gastos de envío(+): <span>{{$settings->currency_icon}}{{getShippingFee()}}</span></p>

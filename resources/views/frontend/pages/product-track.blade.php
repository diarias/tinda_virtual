    ...
    <section id="wsus__breadcrumb">
        <div class="wsus_breadcrumb_overlay">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4>Tracking de la Orden</h4>
                        <ul>
                            <li><a href="#">Inicio</a></li>
                            <li><a href="#">Tracking de la orden</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="wsus__track_area">
                <div class="row">
                    <div class="col-xl-5 col-md-10 col-lg-8 m-auto">
                        ...
                        <form class="tack_form" action="{{route('product-traking.index')}}" method="GET">
                            ...
                            <h4 class="text-center">Tacking de la orden</h4>
                            <p class="text-center">revisa el estado de tu orden</p>
                            <div class="wsus__track_input">
                                <label class="d-block mb-2">id del pedido*</label>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <a href="{{url('/')}}" class="common_btn"><i class="fas fa-chevron-left"></i> Regresa al inicio</a>
                    </div>
                </div>
                @endif
            </div>

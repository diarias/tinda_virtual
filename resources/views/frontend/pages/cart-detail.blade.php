            ...
            <div class="row">
                                ...
                                <tbody>
                                    <tr class="d-flex">
                                        ...
                                        <th class="wsus__pro_icon">
                                            <a href="#" class="common_btn clear_cart">vaciar carrito</a>
                                        </th>
                                    </tr>
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            <td class="">
                                                <form class="product_qty_wrapper">
                                                    ...
                                                    {{-- <div class="wsus__quentity product_qty_wrapper">
                                                    <div class="select_number">
                                                        <input class="number_area product-qty" data-rowid="{{$item->rowId}}" name="qty" type="text" min="1"
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        ...
                        <p>Cupón(-): <span id="discount">{{getCartDiscount()}}</span></p>
                        ...
                        <a class="common_btn mt-4 w-100 text-center" href="{{route('user.checkout')}}">verificar</a>
                        <a class="common_btn mt-1 w-100 text-center" href="{{route('home')}}"><i
                                class="fab fa-shopify"></i>Seguir comprando</a>
                    </div>
                </div>
            </div>
        </div>

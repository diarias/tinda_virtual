...
@section('title')
{{$settings->site_name}} || Detalle del Producto
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-md-7 col-lg-7">
                        <div class="wsus__pro_details_text">
                            ...
                            @if ($product->qty > 0)
                            <p class="wsus__stock_area"><span class="in_stock">Disponible</span> ({{$product->qty}} item)</p>
                            @elseif ($product->qty === 0)
                            <p class="wsus__stock_area"><span class="in_stock">No Disponible</span> ({{$product->qty}} item)</p>
                            @endif
                           ...
                           <p class="description">{!! $product->short_description !!}</p>
                            ...
                            <form class="shopping-cart-form">
                                ...
                                <ul class="wsus__button_area">
                                    <li><button type="submit" class="add_cart" href="#">Agregar al carro</button></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                                                <div class="wsus__pro_det_vendor_text">
                                                    ...
                                                    <p><span>Tienda:</span> {{$product->vendor->shop_name}}</p>
                                                    <p><span>Dirección:</span> {{$product->vendor->address}}</p>
                                                    <p><span>Telefono:</span> {{$product->vendor->phone}}</p>
                                                    <p><span>Email:</span> {{$product->vendor->email}}</p>
                                                    <a href="{{route('vendor.products', $product->vendor->id)}}" class="common_btn">Visitar Tienda</a>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                ...
                                                <div class="col-xl-4 col-lg-5 mt-4 mt-lg-0">
                                                    ...
                                                    <div class="wsus__post_comment rev_mar" id="sticky_sidebar3">
                                                        ...
                                                        <form action="{{route('user.review.create')}}" enctype="multipart/form-data" method="POST">
                                                            ...
                                                            <button class="common_btn" type="submit">Enviar comentario</button>
                                                        </form>
                                                    </div>
                                                    @endif
                                                    @endauth
            ...
            $('.message_modal').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('.message-box').val('');
                        $('.modal-body').append(`<div class="alert alert-info mt-2"><a href="{{ route('user.messages.index') }}" class="text-primary">Click here</a> for go to messenger.</div>`)

                                ...
                                <div class="">
                                    <div class="wsus__invoice_area">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4 col-md-4">
                                                        <div class="wsus__invoice_single text-md-end">
                                                            <h5>Id Pedido: #{{ $order->invoice_id }}</h5>
                                                            <h6>Estado de pedido:
                                        ...
                                        <div class="wsus__invoice_footer">
                                            ...
                                            <p><span>Gastos de envío(+):</span>{{ @$settings->currency_icon }} {{@$shipping->cost}} </p>
                                            <p><span>Cupón(-):</span>{{ @$settings->currency_icon }} {{@$coupon->discount ? $coupon->discount : 0}}</p>
                                            <p><span>Total monto :</span>{{ @$settings->currency_icon }} {{@$order->amount}}</p>

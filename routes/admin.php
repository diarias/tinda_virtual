...
Route::put('products-variant-item-status', [ProductVariantItemController::class,'changeStatus'])->name('products-variant-item.changeStatus');

/** reviews routes */
Route::get('reviews', [AdminReviewController::class, 'index'])->name('reviews.index');
Route::put('reviews/change-status', [AdminReviewController::class, 'changeStatus'])->name('reviews.change-status');

/** Saler products routes */
...
Route::get('payment-settingd', [PaymentSettingController::class, 'index'])->name('payment-settings.index');
